...
static void stem_node_decl_init(eris_node_decl_t *node, ctk_rtti_t *meta) {
...
static ctk_rtti_t eris_node_function_decl_rtti = {
    ...
    .attrs = {
        CTK_RTTI_ATTR(eris_node_function_decl_t, name, CTK_TYPE_INVALID),
    }
};
...
eris_node_decl_t *eris_node_function_decl_new(ctk_token_t *name) {
    ...
    stem_node_decl_init(&node->decl, &eris_node_function_decl_rtti);
    node->name = name;
...
static ctk_rtti_t eris_node_return_rtti = {
    ...
    .super = &eris_node_stmt_rtti,
    .attrs = {
        CTK_RTTI_ATTR(eris_node_return_t, token, CTK_TYPE_INVALID),
...
static ctk_rtti_t eris_node_intlit_rtti = {
    ...
    .attrs = {
        CTK_RTTI_ATTR(eris_node_intlit_t, token, CTK_TYPE_INVALID),
